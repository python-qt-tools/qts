...
project = "qts"
copyright = "The qts authors"
author = "The qts authors"
...
version = importlib_metadata.version("qts")
...
def process_newsfragments():
    ...
    subprocess.run(
        [bin / "towncrier", "build", "--yes", "--name", "qts"],
        check=True,
        cwd="../..",
    )
...
latex_documents = [
    (master_doc, "qts.tex", "qts Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "qts", "qts Documentation", [author], 1)]
